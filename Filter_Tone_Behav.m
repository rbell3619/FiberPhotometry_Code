function [ToneMatrix_GRAB,ToneMatrix_ISO,ToneHitMatrix_GRAB,ToneHitMatrix_ISO,ToneFAMatrix_GRAB,ToneFAMatrix_ISO,ITIMatrix_GRAB,ITIMatrix_ISO,HitMatrix_GRAB,HitMatrix_ISO,FAMatrix_GRAB,FAMatrix_ISO,RT_Hit,RT_FA,OctaveHitMatrix_GRAB,OctaveHitMatrix_ISO,OctaveFAMatrix_GRAB,OctaveFAMatrix_ISO,ITIHitMatrix_GRAB,ITIHitMatrix_ISO,ITIFAMatrix_GRAB,ITIFAMatrix_ISO,ToneHitRT,ToneFART,OctaveHitRT,OctaveFART]=Filter_Tone_Behav(data,Trial_Counter,Epoc_Range,GRAB,ISO,Behav_List)
...
[ToneMatrix_GRAB,ToneMatrix_ISO,ToneHitMatrix_GRAB,ToneHitMatrix_ISO,ToneFAMatrix_GRAB,ToneFAMatrix_ISO, ...
    ...
    ITIHitMatrix_ISO,ITIFAMatrix_GRAB,ITIFAMatrix_ISO,ToneHitRT,ToneFART,OctaveHitRT,OctaveFART]=med_assoc_sort(dayofdata,Grab_stream,ISO_stream);
end
