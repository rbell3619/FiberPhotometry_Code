function [FinalRTHits_Laser,FinalRTHits_NonLaser,FinalRTFA_Laser,FinalRTFA_NonLaser,HitRate_Laser,HitRate_NonLaser,OctaveHitRate_Laser,OctaveHitRate_NonLaser]=Distractor_RateCalc_FP(Behav_List)
...
for LaserTrialNumbers=1:length(Behav_List) %Seperating Laser Trials and non laser trials
load(Behav_List)
LaserTrials={};
NonLaserTrials={};
subject=dayofdata;
