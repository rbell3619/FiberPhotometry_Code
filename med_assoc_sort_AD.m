function [ToneMatrix_GRAB,ToneMatrix_ISO,ToneHitMatrix_GRAB,ToneHitMatrix_ISO,ToneFAMatrix_GRAB,ToneFAMatrix_ISO,HitMatrix_GRAB,HitMatrix_ISO,FAMatrix_GRAB,FAMatrix_ISO,RT_Hit,RT_FA,OctaveHitMatrix_GRAB,OctaveHitMatrix_ISO,OctaveFAMatrix_GRAB,OctaveFAMatrix_ISO,ToneHitRT,ToneFART,OctaveHitRT,OctaveFART]=med_assoc_sort_AD(dayofdata,Grab_stream,ISO_stream)
%ITIMatrix_GRAB,ITIMatrix_ISO,,ITIHitMatrix_GRAB,ITIHitMatrix_ISO,ITIFAMatrix_GRAB,ITIFAMatrix_ISO
for i=1:7
    ...
    ToneHitRT{i}=[RT_left_Hit;RT_right_Hit];
    ...
    ToneFART{i}=[RT_left_FA;RT_right_FA];
